...
import StatusKeranjanghModal from '@/app/modals/statusKeranjang';
...
const ProductCard = (props) => {
  ...
  const [showStatusKeranjang, setShowStatusKeranjang] = useState(false);
  const [statusKeranjangProduct, setStatusKeranjangProduct] = useState({});
  ...
  const handleAddToCart = (e, product, variant, quantity) => {
    ...
    if (variant) {
      ...
      setStatusKeranjangProduct({
        ...products, // Menyalin semua data produk
        quantity: quantity,
        variant: variant // Menambahkan informasi varian yang dipilih
      });
      setShowStatusKeranjang(true);
  ...
  return (
    <Fragment>
            ...
            <Fragment>
              <div className="mt-4">
                <p>
                  ...
                  product?.id_kategori === 2 ||
                  product?.id_kategori === 7
                    ? 'Varian '
                    : 'Ukuran '}
      ...
      <StatusKeranjanghModal
        show={showStatusKeranjang}
        onClose={() => {
          setShowStatusKeranjang(false);
          setStatusKeranjangProduct({});
        }}
        product={statusKeranjangProduct}
      />
    </Fragment>
  );
};
